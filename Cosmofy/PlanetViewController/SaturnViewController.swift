...
class SaturnViewController: UIViewController,
    ...
    var arrayPhotos =
    [
        UIImage(named: "20240114_Saturn_1")!,
        UIImage(named: "20240114_Saturn_2")!,
        UIImage(named: "20240114_Saturn_3")!
    ]
...
//        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "saturnCell", for: indexPath) as! SaturnCell
    ...
    @objc func addPulse () {
        ...
        pulse1.backgroundColor = UIColor(named: "colorSaturn")?.cgColor
        pulse2.backgroundColor = UIColor(named: "colorSaturn")?.cgColor
        pulse5.backgroundColor = UIColor(named: "colorSaturn")?.cgColor
    ...
    @objc func moveToNextIndex() {
        ...
        if (currentLabel == 0) {
            ...
            UIView.transition(with: coreLabel1,
                ...
                self?.coreLabel1.text = "One day on Saturn"
                     }, completion: nil)
            ...
            UIView.transition(with: coreLabel2,
                          duration: 0.25,
                           options: .transitionCrossDissolve,
                        animations: { [weak self] in
                self?.coreLabel2.text = "is 10.7 hours"
                     }, completion: nil)
            ...
            UIView.transition(with: coreLabel1,
                          duration: 0.25,
                              options: .transitionCrossDissolve,
                        animations: { [weak self] in
                self?.coreLabel1.text = "The mass of Saturn"
                     }, completion: nil)
            ...
            UIView.transition(with: coreLabel2,
                          duration: 0.25,
                              options: .transitionCrossDissolve,
                        animations: { [weak self] in
                self?.coreLabel2.text = "is 95 times than of Earth"
                     }, completion: nil)
            currentLabel = currentLabel + 1
            ...
            UIView.transition(with: coreLabel1,
                          duration: 0.25,
                           options: .transitionCrossDissolve,
                        animations: { [weak self] in
                self?.coreLabel1.text = "Saturn is the least"
                     }, completion: nil)
            ...
            UIView.transition(with: coreLabel2,
                          duration: 0.25,
                           options: .transitionCrossDissolve,
                        animations: { [weak self] in
                self?.coreLabel2.text = "dense planet in the Solar System"
                     }, completion: nil)
