...
class NeptuneViewController: UIViewController,
    ...
    var arrayPhotos =
    [
        UIImage(named: "20240114_Neptune_1")!,
        UIImage(named: "20240114_Neptune_2")!,
        UIImage(named: "20240114_Neptune_3")!
    ]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "neptuneCell", for: indexPath) as! NeptuneCell
    ...
    @objc func addPulse () {
        ...
        pulse1.backgroundColor = UIColor(named: "colorNeptune")?.cgColor
        pulse2.backgroundColor = UIColor(named: "colorNeptune")?.cgColor
        pulse5.backgroundColor = UIColor(named: "colorNeptune")?.cgColor
    ...
    @objc func moveToNextIndex() {
        ...
        if (currentLabel == 0) {
            ...
            UIView.transition(with: coreLabel1,
                ...
                self?.coreLabel1.text = "A year on Neptune"
                     }, completion: nil)
            ...
            UIView.transition(with: coreLabel2,
                          duration: 0.25,
                           options: .transitionCrossDissolve,
                        animations: { [weak self] in
                self?.coreLabel2.text = "is about 165 Earth years"
                     }, completion: nil)
            ...
            UIView.transition(with: coreLabel1,
                          duration: 0.25,
                              options: .transitionCrossDissolve,
                        animations: { [weak self] in
                self?.coreLabel1.text = "Neptune was "
                     }, completion: nil)
            ...
            UIView.transition(with: coreLabel2,
                          duration: 0.25,
                              options: .transitionCrossDissolve,
                        animations: { [weak self] in
                self?.coreLabel2.text = "discovered in 1846"
                     }, completion: nil)
            currentLabel = currentLabel + 1
            ...
            UIView.transition(with: coreLabel1,
                          duration: 0.25,
                           options: .transitionCrossDissolve,
                        animations: { [weak self] in
                self?.coreLabel1.text = "Neptune cannot be"
                     }, completion: nil)
            ...
            UIView.transition(with: coreLabel2,
                          duration: 0.25,
                           options: .transitionCrossDissolve,
                        animations: { [weak self] in
                self?.coreLabel2.text = "seen with the naked eye"
                     }, completion: nil)
