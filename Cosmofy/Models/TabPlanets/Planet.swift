...
let neptunePlanet = Planet(
    ...
    description: "A deep blue and distant gas giant with turbulent weather.",
...
let mercuryPlanet = Planet(
    ...
    imageNameClosed: "smiling-neptune",
    description: "The closest planet to the Sun, facing extreme temperatures.",
...
let venusPlanet = Planet(
    ...
    imageNameClosed: "smiling-neptune",
    description: "A planet known for its thick, toxic atmosphere and scorching heat.",
    visual: "Sometime between 1610s and 1630s",
    color: .colorVenus,
    moons: 0,
    rings: 0,
...
let earthPlanet = Planet(
    ...
    imageNameClosed: "smiling-neptune",
    description: "The blue planet, rich with life and diverse ecosystems.",
...
let marsPlanet = Planet(
    ...
    imageNameClosed: "smiling-neptune",
    description: "The red planet, noted for its intriguing geological features.",
    visual: "After the 16th century",
    color: .colorMars,
    moons: 2,
    rings: 0,
...
let jupiterPlanet = Planet(
    ...
    imageNameClosed: "smiling-neptune",
    description: "The largest planet, famous for its massive Great Red Spot storm.",
    visual: "After the 16th century",
    color: .colorJupiter,
    moons: 95,
    rings: 4,
...
let saturnPlanet = Planet(
    ...
    imageNameClosed: "smiling-neptune",
    description: "Known for its stunning rings and its gas giant composition.",
...
let uranusPlanet = Planet(
    ...
    imageNameClosed: "smiling-neptune",
    description: "Distinctive for its tilted axis and pale blue-green coloration.",
